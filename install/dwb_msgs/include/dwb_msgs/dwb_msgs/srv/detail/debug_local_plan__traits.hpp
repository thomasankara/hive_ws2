...
struct has_fixed_size<dwb_msgs::srv::DebugLocalPlan_Request>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::PoseStamped>::value && has_fixed_size<nav_2d_msgs::msg::Twist2D>::value && has_fixed_size<nav_msgs::msg::Path>::value> {};

template<>
struct has_bounded_size<dwb_msgs::srv::DebugLocalPlan_Request>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::PoseStamped>::value && has_bounded_size<nav_2d_msgs::msg::Twist2D>::value && has_bounded_size<nav_msgs::msg::Path>::value> {};
