...
class Metaclass_ClearCostmapAroundRobot_Event(type):
    """Metaclass of message 'ClearCostmapAroundRobot_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__clear_costmap_around_robot__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__clear_costmap_around_robot__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__clear_costmap_around_robot__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__clear_costmap_around_robot__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__clear_costmap_around_robot__event
...
class ClearCostmapAroundRobot_Event(metaclass=Metaclass_ClearCostmapAroundRobot_Event):
    """Message class 'ClearCostmapAroundRobot_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<nav2_msgs/ClearCostmapAroundRobot_Request, 1>',
        'response': 'sequence<nav2_msgs/ClearCostmapAroundRobot_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav2_msgs', 'srv'], 'ClearCostmapAroundRobot_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav2_msgs', 'srv'], 'ClearCostmapAroundRobot_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from nav2_msgs.srv import ClearCostmapAroundRobot_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ClearCostmapAroundRobot_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ClearCostmapAroundRobot_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from nav2_msgs.srv import ClearCostmapAroundRobot_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ClearCostmapAroundRobot_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ClearCostmapAroundRobot_Response'"
        self._response = value
...
class Metaclass_ClearCostmapAroundRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _clear_costmap_around_robot.Metaclass_ClearCostmapAroundRobot_Event._TYPE_SUPPORT is None:
                _clear_costmap_around_robot.Metaclass_ClearCostmapAroundRobot_Event.__import_type_support__()
...
class ClearCostmapAroundRobot(metaclass=Metaclass_ClearCostmapAroundRobot):
    ...
    from nav2_msgs.srv._clear_costmap_around_robot import ClearCostmapAroundRobot_Event as Event
