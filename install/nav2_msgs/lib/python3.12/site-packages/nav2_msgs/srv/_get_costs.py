...
class Metaclass_GetCosts_Event(type):
    """Metaclass of message 'GetCosts_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_costs__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_costs__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_costs__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_costs__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_costs__event
...
class GetCosts_Event(metaclass=Metaclass_GetCosts_Event):
    """Message class 'GetCosts_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<nav2_msgs/GetCosts_Request, 1>',
        'response': 'sequence<nav2_msgs/GetCosts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav2_msgs', 'srv'], 'GetCosts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['nav2_msgs', 'srv'], 'GetCosts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from nav2_msgs.srv import GetCosts_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetCosts_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetCosts_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from nav2_msgs.srv import GetCosts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetCosts_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetCosts_Response'"
...
class Metaclass_GetCosts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_costs.Metaclass_GetCosts_Event._TYPE_SUPPORT is None:
                _get_costs.Metaclass_GetCosts_Event.__import_type_support__()
...
class GetCosts(metaclass=Metaclass_GetCosts):
    ...
    from nav2_msgs.srv._get_costs import GetCosts_Event as Event
