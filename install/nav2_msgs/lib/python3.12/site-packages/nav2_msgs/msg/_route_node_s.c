...
bool nav2_msgs__msg__route_node__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._route_node.RouteNode", full_classname_dest, 35) == 0);
  }
  nav2_msgs__msg__RouteNode * ros_message = _ros_message;
  {  // nodeid
    ...
    ros_message->nodeid = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // position
...
{
  /* NOTE(esteve): Call constructor of RouteNode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._route_node");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RouteNode");
  ...
  nav2_msgs__msg__RouteNode * ros_message = (nav2_msgs__msg__RouteNode *)raw_ros_message;
  {  // nodeid
    PyObject * field = NULL;
