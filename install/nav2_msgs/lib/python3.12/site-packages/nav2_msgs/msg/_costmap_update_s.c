...
bool nav2_msgs__msg__costmap_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._costmap_update.CostmapUpdate", full_classname_dest, 43) == 0);
  }
  nav2_msgs__msg__CostmapUpdate * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CostmapUpdate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._costmap_update");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CostmapUpdate");
