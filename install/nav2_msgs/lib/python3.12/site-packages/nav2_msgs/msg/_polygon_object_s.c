...
bool nav2_msgs__msg__polygon_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._polygon_object.PolygonObject", full_classname_dest, 43) == 0);
  }
  nav2_msgs__msg__PolygonObject * ros_message = _ros_message;
  {  // header
...
PyObject * nav2_msgs__msg__polygon_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._polygon_object");
  ...
  nav2_msgs__msg__PolygonObject * ros_message = (nav2_msgs__msg__PolygonObject *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
