...
class Metaclass_CriticsStats(type):
...
class CriticsStats(metaclass=Metaclass_CriticsStats):
    ...
    def __init__(self, **kwargs):
        ...
        self.critics = kwargs.get('critics', [])
        self.changed = kwargs.get('changed', [])
        self.costs_sum = array.array('f', kwargs.get('costs_sum', []))
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'critics' field must be a set or sequence and each value of type 'str'"
        self._critics = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'changed' field must be a set or sequence and each value of type 'bool'"
        self._changed = value
    ...
    def costs_sum(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'costs_sum' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._costs_sum = array.array('f', value)
