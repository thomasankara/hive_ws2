...
class Init_NavigateThroughPoses_Result_waypoint_statuses
{
public:
  explicit Init_NavigateThroughPoses_Result_waypoint_statuses(::nav2_msgs::action::NavigateThroughPoses_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::NavigateThroughPoses_Result waypoint_statuses(::nav2_msgs::action::NavigateThroughPoses_Result::_waypoint_statuses_type arg)
  {
    msg_.waypoint_statuses = std::move(arg);
    return std::move(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_NavigateThroughPoses_Result_waypoint_statuses error_msg(::nav2_msgs::action::NavigateThroughPoses_Result::_error_msg_type arg)
  {
    msg_.error_msg = std::move(arg);
    return Init_NavigateThroughPoses_Result_waypoint_statuses(msg_);
  }
...
class Init_NavigateThroughPoses_Feedback_waypoint_statuses
{
public:
  explicit Init_NavigateThroughPoses_Feedback_waypoint_statuses(::nav2_msgs::action::NavigateThroughPoses_Feedback & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::NavigateThroughPoses_Feedback waypoint_statuses(::nav2_msgs::action::NavigateThroughPoses_Feedback::_waypoint_statuses_type arg)
  {
    msg_.waypoint_statuses = std::move(arg);
    return std::move(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_NavigateThroughPoses_Feedback_waypoint_statuses number_of_poses_remaining(::nav2_msgs::action::NavigateThroughPoses_Feedback::_number_of_poses_remaining_type arg)
  {
    msg_.number_of_poses_remaining = std::move(arg);
    return Init_NavigateThroughPoses_Feedback_waypoint_statuses(msg_);
  }
