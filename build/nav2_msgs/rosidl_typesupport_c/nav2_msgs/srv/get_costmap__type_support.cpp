...
static const _GetCostmap_Event_type_support_symbol_names_t _GetCostmap_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav2_msgs, srv, GetCostmap_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, srv, GetCostmap_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nav2_msgs, srv, GetCostmap_Event)() {
  return &::nav2_msgs::srv::rosidl_typesupport_c::GetCostmap_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetCostmap_service_type_support_handle = {
  ...
  &GetCostmap_Request_message_type_support_handle,
  &GetCostmap_Response_message_type_support_handle,
  &GetCostmap_Event_message_type_support_handle,
