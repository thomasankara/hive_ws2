...
class Metaclass_GetShapes_Request(type):
...
class GetShapes_Request(metaclass=Metaclass_GetShapes_Request):
...
class Metaclass_GetShapes_Response(type):
...
class GetShapes_Response(metaclass=Metaclass_GetShapes_Response):
...
class Metaclass_GetShapes_Event(type):
...
class GetShapes_Event(metaclass=Metaclass_GetShapes_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetShapes_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetShapes_Response'"
        self._response = value


class Metaclass_GetShapes(type):
...
class GetShapes(metaclass=Metaclass_GetShapes):
    from nav2_msgs.srv._get_shapes import GetShapes_Request as Request
    from nav2_msgs.srv._get_shapes import GetShapes_Response as Response
    from nav2_msgs.srv._get_shapes import GetShapes_Event as Event
