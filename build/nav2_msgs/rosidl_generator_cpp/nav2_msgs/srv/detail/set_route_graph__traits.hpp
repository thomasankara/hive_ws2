...
inline std::string to_yaml(const SetRouteGraph_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use nav2_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const nav2_msgs::srv::SetRouteGraph_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  nav2_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use nav2_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const nav2_msgs::srv::SetRouteGraph_Event & msg)
{
  return nav2_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<nav2_msgs::srv::SetRouteGraph_Event>()
{
  return "nav2_msgs::srv::SetRouteGraph_Event";
}

template<>
inline const char * name<nav2_msgs::srv::SetRouteGraph_Event>()
{
  return "nav2_msgs/srv/SetRouteGraph_Event";
}

template<>
struct has_fixed_size<nav2_msgs::srv::SetRouteGraph_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<nav2_msgs::srv::SetRouteGraph_Event>
  : std::integral_constant<bool, has_bounded_size<nav2_msgs::srv::SetRouteGraph_Request>::value && has_bounded_size<nav2_msgs::srv::SetRouteGraph_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<nav2_msgs::srv::SetRouteGraph_Event>
  : std::true_type {};
