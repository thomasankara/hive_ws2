...
struct NavigateThroughPoses_Result_
{
  ...
  using _waypoint_statuses_type =
    std::vector<nav2_msgs::msg::WaypointStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::msg::WaypointStatus_<ContainerAllocator>>>;
  _waypoint_statuses_type waypoint_statuses;
  ...
  Type & set__waypoint_statuses(
    const std::vector<nav2_msgs::msg::WaypointStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::msg::WaypointStatus_<ContainerAllocator>>> & _arg)
  {
    this->waypoint_statuses = _arg;
    return *this;
  }
  ...
  bool operator==(const NavigateThroughPoses_Result_ & other) const
  {
    ...
    if (this->waypoint_statuses != other.waypoint_statuses) {
      return false;
    }
    return true;
  }
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t NavigateThroughPoses_Result_<ContainerAllocator>::TIMEOUT;
#endif  // __cplusplus < 201703L
