...
#include "nav2_msgs/msg/detail/polygon_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav2_msgs::msg::PolygonObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::msg::PolygonObject & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::msg::PolygonObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::PolygonObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::msg::PolygonObject *>(
    untyped_ros_message);
...
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_PolygonObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, msg, PolygonObject)() {
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_PolygonObject__handle;
}
