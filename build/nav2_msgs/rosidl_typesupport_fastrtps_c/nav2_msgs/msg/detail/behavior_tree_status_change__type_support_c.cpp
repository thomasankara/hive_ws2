  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__msg__BehaviorTreeStatusChange * ros_message = static_cast<const nav2_msgs__msg__BehaviorTreeStatusChange *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__msg__BehaviorTreeStatusChange(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__msg__BehaviorTreeStatusChange * ros_message = static_cast<nav2_msgs__msg__BehaviorTreeStatusChange *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__msg__BehaviorTreeStatusChange(cdr, ros_message);
}
