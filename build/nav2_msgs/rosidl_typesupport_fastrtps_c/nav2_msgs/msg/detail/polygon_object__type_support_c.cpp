...
#include "nav2_msgs/msg/detail/polygon_object__rosidl_typesupport_fastrtps_c.h"
...
using _PolygonObject__ros_msg_type = nav2_msgs__msg__PolygonObject;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs__msg__PolygonObject;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__msg__PolygonObject * ros_message = static_cast<const nav2_msgs__msg__PolygonObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__msg__PolygonObject(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__msg__PolygonObject * ros_message = static_cast<nav2_msgs__msg__PolygonObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__msg__PolygonObject(cdr, ros_message);
}

static uint32_t _PolygonObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav2_msgs__msg__PolygonObject(
...
static size_t _PolygonObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav2_msgs__msg__PolygonObject(
