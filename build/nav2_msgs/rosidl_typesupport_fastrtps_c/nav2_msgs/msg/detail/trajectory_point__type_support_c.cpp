...
#include "nav2_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryPoint__ros_msg_type = nav2_msgs__msg__TrajectoryPoint;
  ...
  nav2_msgs__msg__TrajectoryPoint * ros_message)
{
  ...
  // Field name: effort
  {
    cdr_deserialize_geometry_msgs__msg__Wrench(cdr, &ros_message->effort);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs__msg__TrajectoryPoint;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__msg__TrajectoryPoint * ros_message = static_cast<const nav2_msgs__msg__TrajectoryPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__msg__TrajectoryPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__msg__TrajectoryPoint * ros_message = static_cast<nav2_msgs__msg__TrajectoryPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__msg__TrajectoryPoint(cdr, ros_message);
}

static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav2_msgs__msg__TrajectoryPoint(
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav2_msgs__msg__TrajectoryPoint(
