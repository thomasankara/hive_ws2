...
bool cdr_serialize_nav2_msgs__msg__CostmapFilterInfo(
  const nav2_msgs__msg__CostmapFilterInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_deserialize_nav2_msgs__msg__CostmapFilterInfo(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs__msg__CostmapFilterInfo * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
bool cdr_serialize_key_nav2_msgs__msg__CostmapFilterInfo(
  const nav2_msgs__msg__CostmapFilterInfo * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t get_serialized_size_key_nav2_msgs__msg__CostmapFilterInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CostmapFilterInfo__ros_msg_type * ros_message = static_cast<const _CostmapFilterInfo__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav2_msgs
size_t max_serialized_size_key_nav2_msgs__msg__CostmapFilterInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav2_msgs__msg__CostmapFilterInfo * ros_message = static_cast<const nav2_msgs__msg__CostmapFilterInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav2_msgs__msg__CostmapFilterInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav2_msgs__msg__CostmapFilterInfo * ros_message = static_cast<nav2_msgs__msg__CostmapFilterInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav2_msgs__msg__CostmapFilterInfo(cdr, ros_message);
}
