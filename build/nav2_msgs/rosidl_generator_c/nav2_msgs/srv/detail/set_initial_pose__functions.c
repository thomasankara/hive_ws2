...
nav2_msgs__srv__SetInitialPose_Request__create(void)
{
...
nav2_msgs__srv__SetInitialPose_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
nav2_msgs__srv__SetInitialPose_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
