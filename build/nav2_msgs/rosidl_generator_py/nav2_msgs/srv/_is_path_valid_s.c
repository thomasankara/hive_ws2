...
bool nav2_msgs__srv__is_path_valid__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // max_cost
    ...
    ros_message->max_cost = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // consider_unknown_as_obstacle
    PyObject * field = PyObject_GetAttrString(_pymsg, "consider_unknown_as_obstacle");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->consider_unknown_as_obstacle = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * nav2_msgs__srv__is_path_valid__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // max_cost
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->max_cost);
    {
  ...
  {  // consider_unknown_as_obstacle
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->consider_unknown_as_obstacle ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "consider_unknown_as_obstacle", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
