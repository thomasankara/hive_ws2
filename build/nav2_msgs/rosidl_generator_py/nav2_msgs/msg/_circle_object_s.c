...
bool nav2_msgs__msg__circle_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._circle_object.CircleObject", full_classname_dest, 41) == 0);
  }
  nav2_msgs__msg__CircleObject * ros_message = _ros_message;
  {  // header
  ...
  {  // fill
    PyObject * field = PyObject_GetAttrString(_pymsg, "fill");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->fill = (Py_True == field);
    Py_DECREF(field);
  }
  {  // value
...
{
  /* NOTE(esteve): Call constructor of CircleObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._circle_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CircleObject");
  ...
  nav2_msgs__msg__CircleObject * ros_message = (nav2_msgs__msg__CircleObject *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // fill
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->fill ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fill", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
