...
bool nav2_msgs__msg__edge_cost__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.msg._edge_cost.EdgeCost", full_classname_dest, 33) == 0);
  }
  nav2_msgs__msg__EdgeCost * ros_message = _ros_message;
  {  // edgeid
...
{
  /* NOTE(esteve): Call constructor of EdgeCost */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.msg._edge_cost");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EdgeCost");
  ...
  nav2_msgs__msg__EdgeCost * ros_message = (nav2_msgs__msg__EdgeCost *)raw_ros_message;
  {  // edgeid
    PyObject * field = NULL;
