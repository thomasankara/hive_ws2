...
#include "hive_interface2/msg/detail/poi_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hive_interface2::msg::PoiArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hive_interface2::msg::PoiArray & ros_message)
{
  // Member: items
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        hive_interface2::msg::typesupport_fastrtps_cpp::max_serialized_size_Poi(
  ...
  if (is_plain) {
    ...
    using DataType = hive_interface2::msg::PoiArray;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hive_interface2
max_serialized_size_key_PoiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: items
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        hive_interface2::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Poi(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const hive_interface2::msg::PoiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hive_interface2::msg::PoiArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PoiArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hive_interface2::msg::PoiArray *>(
...
static size_t _PoiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PoiArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PoiArray__callbacks = {
  "hive_interface2::msg",
  "PoiArray",
...
static rosidl_message_type_support_t _PoiArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PoiArray__callbacks,
...
{
  return &hive_interface2::msg::typesupport_fastrtps_cpp::_PoiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hive_interface2, msg, PoiArray)() {
  return &hive_interface2::msg::typesupport_fastrtps_cpp::_PoiArray__handle;
}
