...
static const _NavBrainCommand_type_support_symbol_names_t _NavBrainCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hive_interface2, msg, NavBrainCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hive_interface2, msg, NavBrainCommand)),
  }
};
...
{
  return &::hive_interface2::msg::rosidl_typesupport_cpp::NavBrainCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hive_interface2, msg, NavBrainCommand)() {
  return get_message_type_support_handle<hive_interface2::msg::NavBrainCommand>();
}
