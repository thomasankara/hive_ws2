  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dwb_msgs__msg__CriticScore * ros_message = static_cast<const dwb_msgs__msg__CriticScore *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dwb_msgs__msg__CriticScore(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dwb_msgs__msg__CriticScore * ros_message = static_cast<dwb_msgs__msg__CriticScore *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dwb_msgs__msg__CriticScore(cdr, ros_message);
}
