...
static const _ScoreTrajectory_Event_type_support_symbol_names_t _ScoreTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, ScoreTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, ScoreTrajectory_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, ScoreTrajectory_Event)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::ScoreTrajectory_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ScoreTrajectory_service_type_support_handle = {
  ...
  &ScoreTrajectory_Request_message_type_support_handle,
  &ScoreTrajectory_Response_message_type_support_handle,
  &ScoreTrajectory_Event_message_type_support_handle,
