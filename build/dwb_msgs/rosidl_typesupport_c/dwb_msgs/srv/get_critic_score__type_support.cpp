...
static const _GetCriticScore_Event_type_support_symbol_names_t _GetCriticScore_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dwb_msgs, srv, GetCriticScore_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dwb_msgs, srv, GetCriticScore_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dwb_msgs, srv, GetCriticScore_Event)() {
  return &::dwb_msgs::srv::rosidl_typesupport_c::GetCriticScore_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetCriticScore_service_type_support_handle = {
  ...
  &GetCriticScore_Request_message_type_support_handle,
  &GetCriticScore_Response_message_type_support_handle,
  &GetCriticScore_Event_message_type_support_handle,
