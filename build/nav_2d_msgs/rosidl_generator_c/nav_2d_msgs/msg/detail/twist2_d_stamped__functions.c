...
nav_2d_msgs__msg__Twist2DStamped__create(void)
{
  ...
  nav_2d_msgs__msg__Twist2DStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav_2d_msgs__msg__Twist2DStamped * data =
      (nav_2d_msgs__msg__Twist2DStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav_2d_msgs__msg__Twist2DStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav_2d_msgs__msg__Twist2DStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
