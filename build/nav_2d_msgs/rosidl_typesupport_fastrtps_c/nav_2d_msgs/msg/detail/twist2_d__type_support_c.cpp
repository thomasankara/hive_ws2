  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const nav_2d_msgs__msg__Twist2D * ros_message = static_cast<const nav_2d_msgs__msg__Twist2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_nav_2d_msgs__msg__Twist2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  nav_2d_msgs__msg__Twist2D * ros_message = static_cast<nav_2d_msgs__msg__Twist2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_nav_2d_msgs__msg__Twist2D(cdr, ros_message);
}
